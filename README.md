...
A mobile-first sportswear store example with live camera garment overlays. It does not include payments, checkout, accounts, or real inventory. PACE is a fictional sample name, with original artwork and no Nike branding or product imagery.
...
Browse nine concept pieces, including four distinct graphic T-shirts. Choose one and tap **Try on camera**. Allow camera access, face the camera, and keep your shoulders and hips visible. Trousers also need your legs in frame. The fitting room lets you switch between designs while the camera is running, switch camera direction, save a preview PNG, or stop the camera. The T-shirt print is drawn in the catalog and on the camera overlay.

## Prototype limits

- All nine garments are labeled as concept products. Their vector artwork and colors are placeholders for actual catalog assets. No prices, materials, sizes, or stock are implied.
